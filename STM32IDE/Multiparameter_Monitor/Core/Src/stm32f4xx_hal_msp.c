...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(oxi_sda_GPIO_Port, oxi_sda_Pin);

    HAL_GPIO_DeInit(oxi_scl_GPIO_Port, oxi_scl_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA0-WKUP     ------> TIM2_CH1
    */
    GPIO_InitStruct.Pin = pwm_tim2_ch1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(pwm_tim2_ch1_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PC10     ------> USART3_TX
    */
    HAL_GPIO_DeInit(GPIOC, usart_emg_rx_Pin|usart_emg_tx_Pin);
